...
const items = [
  {
    ...
    description:
      'This is where you can look for an event to register and attempt quiz.',
        ...
        <Grid item xs={12} md={6}>
          <div>
            ...
            <Typography
              ...
              sx={{ mb: { xs: 2, sm: 4 } }}
            >
              Utilise this section as much as you can to look for an event and attempt some quizzes and 
              keep in track with your progress and more importantly not missing your event date!!
            </Typography>
          </div>
              ...
              >
                ...
                >
                  ...
                  <Box sx={{ textTransform: 'none' }}>
                    ...
                    <Link
                      key={index} 
                      href={`${path}?Name=${Name}&email=${email}`}
                      color="primary"
                      variant="body2"
                      fontWeight="bold"
                      sx={{
